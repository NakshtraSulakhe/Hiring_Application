...
namespace Hiring_Application.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JobId,Title,Description,DatePosted,Slots")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobId,Title,Description,DatePosted,Slots")] Job job)
        {
            if (id != job.JobId)
            {
                return NotFound();
